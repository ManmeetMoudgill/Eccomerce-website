...
const EcoSmallDevicesHeaderComponent = () => {
    return <div className="flex flex-col w-full bg-[#F9F9F9] p-5">
        ...
        <div className='w-full relative flex mt-7'>
                    <input 
                     type="text" className=' p-[10px] lg:p-3 bg-white outline-none border-[1px] shadow-lg rounded-3xl w-full' />
                    <span className={`absolute right-0 rounded-r-3xl flex justify-center items-center px-2  text-center  h-full`}>
